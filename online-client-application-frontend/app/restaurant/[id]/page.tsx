...
const restaurant = {
  ...
  tags: ["Popular", "Vegetarian Friendly", "Family Restaurant"],
  isOpen: true,
}
    ...
    items: [
      {
        ...
        price: 850,
        image: "/bruschetta-appetizer.jpg",
        isVegetarian: true,
        isPopular: true,
      },
      {
...
const restaurantReviews = [
  {
    ...
    rating: 5,
    date: "2 days ago",
    comment: "Amazing authentic Italian food! The pizza was perfect and the service was excellent.",
    helpful: 12,
  ...
  },
  {
    ...
    rating: 5,
    date: "2 weeks ago",
    comment: "Best Italian restaurant in Algiers. The carbonara is to die for!",
    helpful: 15,
    avatar: "/placeholder.svg",
  },
]
